export class ErrorDetectionService {
    ...
    createErrorReport(outputs, runtimeErrors) {
    ...
    generateErrorFixPrompt(errorReport) {
    ...
    reportErrors(appId, errorReport) {
    ...
    analyzeAndReport(appId, outputs, runtimeErrors) {
