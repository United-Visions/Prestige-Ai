export class CodebaseExtractionService {
    ...
    async getFilesRecursively(dirPath, relativePath = '') {
        try {
    ...
    async formatCodebaseInfo(files, basePath) {
        let output = '';
...
export const createCodebasePrompt = (codebaseInfo) => {
