...
export class AIProblemDetector {
    constructor() {
        Object.defineProperty(this, "modelEndpoint", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    async analyzeCodeWithAI(code, filePath, language = 'typescript') {
        try {
            // Check cache first
     ...
     */
    async streamingAnalyze(partialCode, fullCode, filePath) {
...
Only return the JSON array, no additional text or explanation.`;
     ...
     */
    buildUserPrompt(code, language, filePath) {
...
Return JSON array of problems found:`;
     ...
     */
    parseAIResponse(response, filePath) {
        try {
     ...
     */
    fallbackToRuleBasedDetection(code, filePath) {
        const problems = [];
     ...
     */
    extractRecentChanges(partialCode, fullCode) {
