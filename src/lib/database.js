...
export function generateDrizzleSchema(schema) {
    const imports = [
...
function getOrmImport(provider) {
    switch (provider) {
...
function generateTableSchema(table, provider) {
...
function getTableFunction(provider) {
    switch (provider) {
...
function mapColumnType(type, _provider) {
